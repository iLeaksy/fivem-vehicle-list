...
INSERT INTO `vehicles` (`name`, `model`, `price`, `category`) VALUES
    ...
    ('Canis Castigator', 'castigator', 0, 'SUVs'),
    ('Invetero Coquette D1', 'coquette5', 20000, 'Sports Classics'),
    ('Vapid Dominator FX', 'dominator10', 20000, 'Muscle'),
    ('Cypher', 'driftcypher', 20000, 'Sports'),
    ('Vulcar Nebula Turbo', 'driftnebula', 20000, 'Sports Classics'),
    ('Ubermacht Sentinel Classic Widebody', 'driftsentinel', 20000, 'Sports'),
    ('Vorschlaghammer', 'driftvorschlag', 20000, 'Sedans'),
    ('Bollokan Envisage', 'envisage', 20000, 'Sports'),
    ('Annis Euros X32', 'eurosX32', 20000, 'Coupes'),
    ('Niobe', 'niobe', 20000, 'Sports'),
    ('Enus Paragon S', 'paragon3', 20000, 'Sports'),
    ('Overflod Pipistrello', 'pipistrello', 20000, 'Super'),
    ('Pegassi Pizza Boy', 'pizzaboy', 20000, 'Motorcycles'),
    ('Vapid Dominator FX Interceptor', 'poldominator10', 20000, 'Emergency'),
    ('Bravado Dorado Cruiser', 'poldorado', 20000, 'Emergency'),
    ('Bravado Greenwood Cruiser', 'polgreenwood', 20000, 'Emergency'),
    ('Burrito (Bail Enforcement)', 'policet3', 20000, 'Emergency'),
    ('Declasse Impaler SZ Cruiser', 'polimpaler5', 20000, 'Emergency'),
    ('Declasse Impaler LX Cruiser', 'polimpaler6', 20000, 'Emergency'),
    ('Vorschlaghammer', 'vorschlaghammer', 20000, 'Sedans'),
    ('Declasse Yosemite 1500', 'yosemite1500', 20000, 'Off-Road'),
	('Vapid Aleutian', 'aleutian', 0, 'SUVs'),
	('Karin Asterope GZ', 'asterope2', 0, 'Sedans'),
	('Gallivanter Baller ST-D', 'baller8', 0, 'SUVs'),
	('Vapid Benson (Cluckin Bell)', 'benson2', 0, 'Commercial'),
	('Boat Trailer', 'boattrailer2', 0, 'Utility'),
	('Boat Trailer', 'boattrailer3', 0, 'Utility'),
	('Brute Boxville (LSDS)', 'boxville6', 0, 'Vans'),
	('Albany Cavalcade XL', 'cavalcade3', 0, 'SUVs'),
	('Vapid Dominator GT', 'dominator9', 0, 'Muscle'),
	('Bravado Dorado', 'dorado', 0, 'SUVs'),
	('Annis Euros', 'drifteuros', 0, 'Sports'),
	('Fathom FR36', 'driftfr36', 0, 'Coupes'),
	('Karin Futo GTX', 'driftfuto', 0, 'Sports'),
	('Dinka Jester RR', 'driftjester', 0, 'Sports'),
	('Annis Remus', 'driftremus', 0, 'Sports'),
	('Declasse Drift Tampa', 'drifttampa', 0, 'Sports'),
	('Declasse Drift Yosemite', 'driftyosemite', 0, 'Muscle'),
	('Annis ZR350', 'driftzr350', 0, 'Sports'),
	('Fathom FR36', 'fr36', 0, 'Coupes'),
	('Freight Train', 'freight2', 0, 'Trains'),
	('Declasse Impaler SZ', 'impaler5', 0, 'Sedans'),
	('Declasse Impaler LX', 'impaler6', 0, 'Muscle'),
	('JoBuilt Phantom', 'phantom4', 0, 'Commercial'),
	('Bravado Gauntlet Interceptor', 'polgauntlet', 0, 'Emergency'),
	('Vapid Stanier LE Cruiser', 'police5', 0, 'Emergency'),
	('Canis Terminus', 'terminus', 0, 'Off-Road'),
	('Tow Truck', 'towtruck3', 0, 'Utility'),
	('Tow Truck', 'towtruck4', 0, 'Utility'),
	('Trailer', 'trailers5', 0, 'Utility'),
	('Grotti Turismo Omaggio', 'turismo3', 0, 'Super'),
	('Trailer', 'tvtrailer2', 0, 'Utility'),
	('Declasse Vigero ZX Convertible', 'Vigero3', 0, 'Muscle'),
	('Karin Vivanite', 'vivanite', 0, 'SUVs'),
    ('Albany Brigham', 'brigham', 0, 'Muscle'),
    ('Bravado Buffalo EVX', 'buffalo5', 0, 'Muscle'),
    ('Vapid Clique Wagon', 'clique2', 0, 'Muscle'),
    ('Penaud La Coureuse', 'coureur', 0, 'Sports'),
    ('Bravado Hotring Hellfire', 'gauntlet6', 0, 'Sports'),
    ('Inductor', 'inductor', 0, 'Cycles'),
    ('Junk Energy Inductor', 'inductor2', 0, 'Cycles'),
    ('Declasse Walton L35', 'l35', 0, 'Off-Road'),
    ('Maibatsu MonstroCiti', 'monstrociti', 0, 'Off-Road'),
    ('Vapid Ratel', 'ratel', 0, 'Off-Road'),
    ('Vapid Speedo Custom', 'speedo5', 0, 'Vans'),
    ('Grotti Itali GTO Stinger TT', 'stingertt', 0, 'Sports');
